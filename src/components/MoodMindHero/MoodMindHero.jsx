// src/components/MoodMindHero/MoodMindHero.jsx
...
/**
 * Componente Hero de la vista MoodMind.
 * Presenta el título principal de la sección (con animación de desenfoque a texto)
 * y un botón para realizar un scroll fluido hacia la sección de características.
 */
const MoodMindHero = () => {
	...
	return (
		<section className='moodmind-hero'>
			<div className='moodmind-hero__container'>
				...
				{/* Bloque Central: Botón CTA y Párrafo descriptivo */}
