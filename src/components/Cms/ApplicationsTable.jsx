...
const ApplicationsTable = ({ applications }) => {
	...
	const exportToCSV = () => {
		...
		// 2. Extraemos los datos de la lista FILTRADA
		...
		// 4. Creamos el archivo y forzamos la descarga
		const blob = new Blob(["\uFEFF" + csvContent], {
			type: "text/csv;charset=utf-8;",
		}); // \uFEFF asegura que Excel lea las tildes correctamente
	...
	return (
		<div className='applications-view'>
			<div className='app-filters-bar'>
				...
				{/* 🌟 BOTONES DE ACCIÓN: GUARDAR Y EXPORTAR (Estilo Shadcn) */}
				...
				<table className='cms-table'>
					...
					<tbody>
						{currentApps.length > 0 ? (
							...
							<tr>
								<td colSpan='8' className='cms-table__empty'>
			...
			{cvModalApp && (
				<div className='cms-modal-overlay' onClick={closeCvModal}>
					<div
					...
					>
						<header className='cms-modal-header'>
							...
							<div className='modal-header-actions'>
								...
								<button className='btn-close' onClick={closeCvModal}>
									<X size={24} />
								</button>
							</div>
						</header>
			...
			{answersModalApp && (
				<div className='cms-modal-overlay' onClick={closeAnswersModal}>
					<div
					...
					>
						<header className='cms-modal-header'>
							...
							<button className='btn-close' onClick={closeAnswersModal}>
								<X size={24} />
							</button>
						</header>
						<div className='cms-modal-body'>
