 ...
 * Gestiona el envío de credenciales y el manejo de respuestas del backend,
 * incluyendo limitaciones de tasa (Rate Limiting) y errores de autenticación.
 */
const CmsLogin = () => {
